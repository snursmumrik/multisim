...
/**
 * Open edit policy for the Display input ports to show the colour picker on double-click.
 * 
 * @author vitaly
 *
 */
public class DisplayPortOpenEditPolicy extends OpenEditPolicy {
	...
	protected Command getOpenCommand(Request request) {
		final DisplayPort port = (DisplayPort) ((GraphicalEditPart) getHost()).resolveSemanticElement();
