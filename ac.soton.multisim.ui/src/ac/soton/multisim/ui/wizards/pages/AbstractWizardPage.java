...
import ac.soton.multisim.ui.wizards.controls.EventBNamedComboContainer;
...
public abstract class AbstractWizardPage extends WizardPage {
	...
	/**
	 * Returns the same composite with fill layout.
	 * @param composite
	 * @return
	 */
	protected Composite fillLayoutComposite(Composite composite) {
