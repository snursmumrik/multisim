...
/**
 * Action for opening a corresponding machine of the EventB component.
 * 
 * @author vitaly
 *
 */
public class OpenMachineAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		if (machine == null || machine.eResource() == null) {
			MessageDialog.openError(Display.getDefault().getActiveShell(), "Machine Failure", "Machine is not set.");
			return;
		}
