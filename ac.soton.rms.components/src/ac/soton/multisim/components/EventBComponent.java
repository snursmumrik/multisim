 ...
 * <ul>
 *   <li>{@link ac.soton.multisim.components.EventBComponent#getMachine <em>Machine</em>}</li>
 *   <li>{@link ac.soton.multisim.components.EventBComponent#isComposed <em>Composed</em>}</li>
 *   <li>{@link ac.soton.multisim.components.EventBComponent#getReadInputEvents <em>Read Input Events</em>}</li>
 *   <li>{@link ac.soton.multisim.components.EventBComponent#getWaitEvents <em>Wait Events</em>}</li>
 *   <li>{@link ac.soton.multisim.components.EventBComponent#getTrace <em>Trace</em>}</li>
 * </ul>
 * </p>
 *
 * @see ac.soton.multisim.components.ComponentsPackage#getEventBComponent()
...
public interface EventBComponent extends AbstractExtension, Component {
	 ...
	 * @see ac.soton.multisim.components.ComponentsPackage#getEventBComponent_Machine()
	 * @model required="true"
	 * @generated
	 */
	Machine getMachine();
	...
	/**
	 * Sets the value of the '{@link ac.soton.multisim.components.EventBComponent#getMachine <em>Machine</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ac.soton.multisim.components.ComponentsPackage#getEventBComponent_Composed()
	 * @model required="true"
	 * @generated
	 */
	boolean isComposed();
	...
	/**
	 * Sets the value of the '{@link ac.soton.multisim.components.EventBComponent#isComposed <em>Composed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ac.soton.multisim.components.ComponentsPackage#getEventBComponent_ReadInputEvents()
	 * @model
	 * @generated
	 */
	 ...
	 * @see ac.soton.multisim.components.ComponentsPackage#getEventBComponent_WaitEvents()
	 * @model required="true"
	 * @generated
	 */
	 ...
	 * @see #setTrace(Trace)
	 * @see ac.soton.multisim.components.ComponentsPackage#getEventBComponent_Trace()
	 * @model dataType="ac.soton.multisim.components.ProBTrace" transient="true"
	 * @generated
	 */
	Trace getTrace();

	/**
	 * Sets the value of the '{@link ac.soton.multisim.components.EventBComponent#getTrace <em>Trace</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
