 ...
 * <ul>
 *   <li>{@link ac.soton.multisim.components.impl.DisplayPortImpl#getTrace <em>Trace</em>}</li>
 *   <li>{@link ac.soton.multisim.components.impl.DisplayPortImpl#getColor <em>Color</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DisplayPortImpl extends PortImpl implements DisplayPort {
	...
	public void setColor(Color newColor) {
		...
		color = newColor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.DISPLAY_PORT__COLOR, oldColor, color));
	}
