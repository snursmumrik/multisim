 ...
 * <ul>
 *   <li>{@link ac.soton.multisim.components.DisplayComponent#getChart <em>Chart</em>}</li>
 * </ul>
 * </p>
 *
 * @see ac.soton.multisim.components.ComponentsPackage#getDisplayComponent()
 * @model
 * @generated
 */
public interface DisplayComponent extends Component {
	 ...
	 * @see ac.soton.multisim.components.ComponentsPackage#getDisplayComponent_Chart()
	 * @model dataType="ac.soton.multisim.components.Chart2D" transient="true"
	 * @generated
	 */
	Chart2D getChart();

	/**
	 * Sets the value of the '{@link ac.soton.multisim.components.DisplayComponent#getChart <em>Chart</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
