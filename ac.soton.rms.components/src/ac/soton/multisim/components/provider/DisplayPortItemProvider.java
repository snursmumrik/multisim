...
/**
 * This is the item provider adapter for a {@link ac.soton.multisim.components.DisplayPort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DisplayPortItemProvider
	...
	protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DisplayPort_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DisplayPort_color_feature", "_UI_DisplayPort_type"),
				 ComponentsPackage.Literals.DISPLAY_PORT__COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DisplayPort.class)) {
			...
			case ComponentsPackage.DISPLAY_PORT__COLOR:
