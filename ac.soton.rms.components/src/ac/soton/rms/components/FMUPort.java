 ...
 * <ul>
 *   <li>{@link ac.soton.rms.components.FMUPort#getFmiName <em>Fmi Name</em>}</li>
 * </ul>
 * </p>
 *
...
public interface FMUPort extends Port {
	 ...
	 * @see ac.soton.rms.components.ComponentsPackage#getFMUPort_FmiName()
	 * @model required="true"
	 * @generated
	 */
	String getFmiName();
	...
	/**
	 * Sets the value of the '{@link ac.soton.rms.components.FMUPort#getFmiName <em>Fmi Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
