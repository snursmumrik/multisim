 ...
 * <ul>
 *   <li>{@link ac.soton.rms.components.impl.FMUPortImpl#getFmiName <em>Fmi Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FMUPortImpl extends PortImpl implements FMUPort {
	...
	public void setFmiName(String newFmiName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.FMU_PORT__FMI_NAME, oldFmiName, fmiName));
	}
