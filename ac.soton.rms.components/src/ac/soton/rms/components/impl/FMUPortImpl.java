 ...
 * <ul>
 *   <li>{@link ac.soton.rms.components.impl.FMUPortImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FMUPortImpl extends PortImpl implements FMUPort {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.FMU_PORT__NAME, oldName, name));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == EventBNamed.class) {
			switch (derivedFeatureID) {
				case ComponentsPackage.FMU_PORT__NAME: return CorePackage.EVENT_BNAMED__NAME;
				default: return -1;
			}
		}
