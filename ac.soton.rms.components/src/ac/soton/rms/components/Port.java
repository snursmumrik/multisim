 ...
 * <ul>
 *   <li>{@link ac.soton.rms.components.Port#getIn <em>In</em>}</li>
 *   <li>{@link ac.soton.rms.components.Port#getOut <em>Out</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Port extends AbstractVariable {
	 ...
	 * It is bidirectional and its opposite is '{@link ac.soton.rms.components.Port#getOut <em>Out</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setIn(Port)
	 * @see ac.soton.rms.components.ComponentsPackage#getPort_In()
	...
	/**
	 * Sets the value of the '{@link ac.soton.rms.components.Port#getIn <em>In</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link ac.soton.rms.components.Port#getIn <em>In</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ac.soton.rms.components.ComponentsPackage#getPort_Out()
