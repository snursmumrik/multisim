...
public class ComponentsModelingAssistantProviderOfComponentDiagramEditPart
	...
	public List<IElementType> getTypesForPopupBar(IAdaptable host) {
		...
		types.add(ComponentsElementTypes.DisplayComponent_2001);
		types.add(ComponentsElementTypes.FMUComponent_2002);
		types.add(ComponentsElementTypes.EventBComponent_2003);
		return types;
	}
