...
import ac.soton.rms.components.diagram.edit.policies.ComponentsTextNonResizableEditPolicy;
import ac.soton.rms.components.diagram.edit.policies.EventBVariableItemSemanticEditPolicy;
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.rms.components.diagram.edit.parts.EventBVariableEditPart.VISUAL_ID));
		}
		return parser;
	}
