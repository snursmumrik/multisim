...
import ac.soton.rms.components.diagram.edit.policies.ComponentsTextSelectionEditPolicy;
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.rms.components.diagram.edit.parts.EventBComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
