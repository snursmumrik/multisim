...
import ac.soton.rms.components.diagram.edit.policies.FMUVariableItemSemanticEditPolicy;
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.rms.components.diagram.edit.parts.FMUVariableEditPart.VISUAL_ID));
		}
		return parser;
	}
