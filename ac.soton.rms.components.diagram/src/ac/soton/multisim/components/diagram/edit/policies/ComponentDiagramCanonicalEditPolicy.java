...
import ac.soton.multisim.components.diagram.part.ComponentsDiagramUpdater;
import ac.soton.multisim.components.diagram.part.ComponentsLinkDescriptor;
import ac.soton.multisim.components.diagram.part.ComponentsNodeDescriptor;
...
public class ComponentDiagramCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	private Collection<ComponentsLinkDescriptor> collectAllLinks(View view,
		...
		case DisplayComponentEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ComponentsDiagramUpdater
						.getDisplayComponent_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case FMUComponentEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ComponentsDiagramUpdater
						.getFMUComponent_2002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case EventBComponentEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ComponentsDiagramUpdater
						.getEventBComponent_2003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
