...
import ac.soton.multisim.components.diagram.edit.commands.EventBInputPortCreateCommand;
import ac.soton.multisim.components.diagram.edit.commands.EventBOutputPortCreateCommand;
...
public class EventBComponentItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (ComponentsElementTypes.EventBPort_3005 == req.getElementType()) {
			return getGEFWrapper(new EventBInputPortCreateCommand(req));
		}
		if (ComponentsElementTypes.EventBPort_3006 == req.getElementType()) {
