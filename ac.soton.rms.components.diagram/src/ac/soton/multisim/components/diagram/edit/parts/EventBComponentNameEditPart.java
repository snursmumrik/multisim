...
import ac.soton.multisim.components.diagram.edit.policies.ComponentsTextSelectionEditPolicy;
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.multisim.components.diagram.edit.parts.EventBComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
