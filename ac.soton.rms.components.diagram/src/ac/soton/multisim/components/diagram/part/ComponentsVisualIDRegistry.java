 ...
 */
package ac.soton.multisim.components.diagram.part;
...
import ac.soton.multisim.components.diagram.expressions.ComponentsOCLFactory;
...
public class ComponentsVisualIDRegistry {
	 ...
	 * @generated
	 */
	private static final String DEBUG_KEY = "ac.soton.multisim.components.diagram/debug/visualID"; //$NON-NLS-1$
	...
	public static int getVisualID(View view) {
		...
		return ac.soton.multisim.components.diagram.part.ComponentsVisualIDRegistry
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = ac.soton.multisim.components.diagram.part.ComponentsVisualIDRegistry
		...
		if (ComponentDiagramEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = ac.soton.multisim.components.diagram.part.ComponentsVisualIDRegistry
