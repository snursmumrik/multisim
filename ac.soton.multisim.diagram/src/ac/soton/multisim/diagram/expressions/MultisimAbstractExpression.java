 ...
 * @generated
 */
public abstract class MultisimAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = MultisimDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected MultisimAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
