 ...
 * @generated
 */
public class MultisimMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = MultisimDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			MultisimDiagramEditorUtil.selectElementsInDiagram(editor,
