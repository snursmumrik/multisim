 ...
 * @generated
 */
public class MultisimViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = MultisimVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = MultisimVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!MultisimElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != MultisimVisualIDRegistry
				...
				if (!ComponentDiagramEditPart.MODEL_ID
						.equals(MultisimVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = MultisimVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != MultisimVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = MultisimVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = MultisimVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case DisplayComponentEditPart.VISUAL_ID:
			return createDisplayComponent_2004(domainElement, containerView,
					index, persisted, preferencesHint);
		case FMUComponentEditPart.VISUAL_ID:
			return createFMUComponent_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case EventBComponentEditPart.VISUAL_ID:
			return createEventBComponent_2006(domainElement, containerView,
					index, persisted, preferencesHint);
		case DisplayPortEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (MultisimVisualIDRegistry.getVisualID(elementTypeHint)) {
	 ...
	 * @generated
	 */
	public Node createDisplayComponent_2004(EObject domainElement,
		...
		node.setType(MultisimVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createFMUComponent_2005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createEventBComponent_2006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	...
	public Edge createPortOut_4001(View containerView, int index,
		...
		edge.setType(MultisimVisualIDRegistry
