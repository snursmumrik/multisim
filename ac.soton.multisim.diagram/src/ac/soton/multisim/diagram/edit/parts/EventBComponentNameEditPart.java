...
import ac.soton.multisim.diagram.edit.policies.MultisimTextSelectionEditPolicy;
...
public class EventBComponentNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new MultisimTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return MultisimElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MultisimParserProvider
					.getParser(
							MultisimElementTypes.EventBComponent_2006,
							getParserElement(),
							MultisimVisualIDRegistry
									.getType(ac.soton.multisim.diagram.edit.parts.EventBComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					MultisimEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
