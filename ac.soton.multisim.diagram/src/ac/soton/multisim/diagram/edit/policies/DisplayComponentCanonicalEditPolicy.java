...
public class DisplayComponentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<MultisimNodeDescriptor> childDescriptors = MultisimDiagramUpdater
				.getDisplayComponent_2004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return DisplayPortEditPart.VISUAL_ID == MultisimVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<MultisimNodeDescriptor> childDescriptors = MultisimDiagramUpdater
				.getDisplayComponent_2004SemanticChildren((View) getHost()
						.getModel());
