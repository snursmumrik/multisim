...
import ac.soton.multisim.diagram.edit.commands.FMUInputPortCreateCommand;
import ac.soton.multisim.diagram.edit.commands.FMUOutputPortCreateCommand;
...
public class FMUComponentItemSemanticEditPolicy extends
	...
	public FMUComponentItemSemanticEditPolicy() {
		super(MultisimElementTypes.FMUComponent_2005);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (MultisimElementTypes.FMUPort_3002 == req.getElementType()) {
			return getGEFWrapper(new FMUInputPortCreateCommand(req));
		}
		if (MultisimElementTypes.FMUPort_3003 == req.getElementType()) {
