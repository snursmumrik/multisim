...
public class EventBComponentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(MultisimPackage.eINSTANCE
					.getComponent_Inputs());
			myFeaturesToSynchronize.add(MultisimPackage.eINSTANCE
	...
	protected List getSemanticChildrenList() {
		...
		List<MultisimNodeDescriptor> childDescriptors = MultisimDiagramUpdater
				.getEventBComponent_2006SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<MultisimNodeDescriptor> childDescriptors = MultisimDiagramUpdater
				.getEventBComponent_2006SemanticChildren((View) getHost()
						.getModel());
		...
		HashMap<MultisimNodeDescriptor, LinkedList<View>> potentialViews = new HashMap<MultisimNodeDescriptor, LinkedList<View>>();
		//
