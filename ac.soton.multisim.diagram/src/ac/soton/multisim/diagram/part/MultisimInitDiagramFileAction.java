 ...
 * @generated
 */
public class MultisimInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new MultisimNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ComponentDiagramEditPart.MODEL_ID));
		MultisimDiagramEditorUtil.runWizard(getShell(), wizard,
