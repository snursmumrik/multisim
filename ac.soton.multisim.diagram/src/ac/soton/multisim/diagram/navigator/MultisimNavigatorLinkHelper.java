 ...
 * @generated
 */
public class MultisimNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = MultisimDiagramEditorPlugin.getInstance()
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		if (abstractNavigatorItem instanceof MultisimNavigatorItem) {
			navigatorView = ((MultisimNavigatorItem) abstractNavigatorItem)
					.getView();
			...
			if (navigatorGroup.getParent() instanceof MultisimNavigatorItem) {
				navigatorView = ((MultisimNavigatorItem) navigatorGroup
						.getParent()).getView();
			}
		}
